...
final class ComponentParameterFactory
{
     ...
     * @param  ?string  $thumbnailProductRetailerId  Item SKU number, labeled as Content ID in the Commerce Manager. Required when sub_type is catalog.
     */
    public static function buttonFlow(?string $flowToken = null, ?array $flowActionData = [], ?string $thumbnailProductRetailerId = null): array
    {
        return [
            [
                'type' => 'action',
